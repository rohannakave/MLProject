...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        ...
        try:
            ...
            logging.info("Numerical coulmn's standard scaling completed.")
            ...
            logging.info("Categorical column's encoding completed.")
    ...
    def initiate_data_transformastion(self, train_path, test_path):
        try:
            ...
            logging.info("Obtaiing preproccesing data.")
